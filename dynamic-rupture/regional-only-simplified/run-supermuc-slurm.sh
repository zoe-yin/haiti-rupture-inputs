...
#SBATCH -J regional-only-simplified
...
OUTPUTDIR="/hppfs/scratch/01/di35poq/haiti-rupture-outputs/dynamic-rupture-outputs/regional-only-simplified/jobid_${SLURM_JOB_ID}"
