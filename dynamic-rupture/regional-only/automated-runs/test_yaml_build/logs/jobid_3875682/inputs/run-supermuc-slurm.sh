...
#SBATCH --partition=test --exclude="i01r01c[01-02]s[01-12]"
#SBATCH --nodes=16
...
/dss/dsshome1/01/di35poq/haiti-rupture-inputs/dynamic-rupture/generate-job-log.sh $SLURM_JOB_ID $PARAMETERS
...
# move all log files to the parent (group automated) directory
mv logs/jobid_${SLURM_JOB_ID} ../logs/jobid_${SLURM_JOB_ID}
...
mkdir -p ../logs/jobid_${SLURM_JOB_ID}/
