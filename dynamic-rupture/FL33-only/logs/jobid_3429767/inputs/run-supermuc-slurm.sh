...
seissol_output_extractor output-fault.xdmf --time "i1:" --variable ASl Ts0 Td0 T_s T_d --add2prefix "_jobid_${SLURM_JOB_ID}_FL33-only_extracted"
seissol_output_extractor output-surface.xdmf --time "i1::2" --variable u1 u2 u3 --add2prefix "_jobid_${SLURM_JOB_ID}_FL33-only_extracted"
popd
# move outputs to a job-id-named folder
mv ${OUTDIR}/outputs_tmp ${OUTDIR}/jobid_${SLURM_JOB_ID}_FL33-only