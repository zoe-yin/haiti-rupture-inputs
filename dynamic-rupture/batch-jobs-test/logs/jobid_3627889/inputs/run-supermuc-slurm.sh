...
# # Define the SLURM_JOB_ID
# SLURM_JOB_ID='123456'

# Define the OUTPUTFILE path
...
# FILE_PATH="/mnt/data/parameters.par"

# Use sed to replace the specific line (line 63)
...
echo 'Hello!' > test_postprocess.txt
...
# mv ${OUTDIR}/outputs_tmp ${OUTDIR}/regional-only-simplified/jobid_${SLURM_JOB_ID}
