...
PARAMETERS=parameters_kin_lowres_step500-smooth7_volumetric.par
srun /dss/dsshome1/01/di35poq/SeisSol/build-release/SeisSol_Release_dskx_4_elastic $PARAMETERS

echo ${0##*/}

./generate-job-log.sh $SLURM_JOB_ID $PARAMETERS ${0##*/}