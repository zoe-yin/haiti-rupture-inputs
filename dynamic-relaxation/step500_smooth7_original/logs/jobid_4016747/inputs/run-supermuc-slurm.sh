...
interpolate_seissol_data_to_grid.py --box "100 600000 700000 2020000 2050000 -40000 0" output_resampled.xdmf --Data sigma_xx sigma_yy sigma_zz sigma_xy sigma_xz sigma_yz --gaussian_smoothing
popd
