...
interpolate_seissol_data_to_grid.py --box "100 600000 700000 2020000 2060000 -40000 1000" output_resampled.xdmf --Data sigma_xx sigma_yy sigma_zz sigma_xy sigma_xz sigma_yz --gaussian_smoothing
popd

# move outputs to a job-id-named folder
mv ${OUTDIR}/outputs_tmp ${OUTDIR}/jobid_${SLURM_JOB_ID}_general