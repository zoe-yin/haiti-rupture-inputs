...
#SBATCH -J step300_smooth5_volumetric
...
srun /dss/dsshome1/01/di35poq/SeisSol/build-release/SeisSol_Release_dskx_4_elastic parameters_kin_lowres_step300-smooth5_volumetric.par