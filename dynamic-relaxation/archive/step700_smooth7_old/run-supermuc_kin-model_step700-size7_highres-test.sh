...
#SBATCH -J haiti-kin-model_step700_smooth7_highres
...
srun /dss/dsshome1/01/di35poq/SeisSol/build-release/SeisSol_Release_dskx_4_elastic parameters_haiti_kinematic-highres_kin-model-step700-size7.par