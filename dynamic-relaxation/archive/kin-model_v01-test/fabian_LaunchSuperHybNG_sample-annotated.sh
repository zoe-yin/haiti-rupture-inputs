...
#SBATCH --nodes=256
#SBATCH --time=00:30:00     # Limit for job run time
...
# Run actual job
mpiexec -n $SLURM_NTASKS /dss/dsshome1/01/di35poq/SeisSol/build-release/SeisSol_proxy_Release_dskx_4_elastic parameters_haiti_kinematic.par